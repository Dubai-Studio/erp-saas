...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    // Le middleware a déjà vérifié la session côté serveur ; ici on récupère
    // juste l'objet user pour l'affichage (nom, email).
    sb.auth.getSession().then(async ({ data }) => {
      ...
      // Charge le nom de la société (cookie-based session, RLS du backend)
      try {
